...
set_property PACKAGE_PIN P3 [get_ports {monB_rx_data[3]}]
set_property PACKAGE_PIN P2 [get_ports {monB_rx_data[2]}]
set_property PACKAGE_PIN N1 [get_ports {monB_rx_data[1]}]
set_property PACKAGE_PIN M2 [get_ports {monB_rx_data[0]}]
set_property PACKAGE_PIN P5 [get_ports {monB_tx_data[3]}]
set_property PACKAGE_PIN L3 [get_ports {monB_tx_data[2]}]
set_property PACKAGE_PIN M3 [get_ports {monB_tx_data[1]}]
set_property PACKAGE_PIN M4 [get_ports {monB_tx_data[0]}]
set_property PACKAGE_PIN D1 [get_ports {monA_rx_data[3]}]
set_property PACKAGE_PIN D2 [get_ports {monA_rx_data[2]}]
set_property PACKAGE_PIN C1 [get_ports {monA_rx_data[1]}]
set_property PACKAGE_PIN B1 [get_ports {monA_rx_data[0]}]
set_property PACKAGE_PIN F1 [get_ports {monA_tx_data[3]}]
set_property PACKAGE_PIN G1 [get_ports {monA_tx_data[2]}]
set_property PACKAGE_PIN J2 [get_ports {monA_tx_data[1]}]
set_property PACKAGE_PIN J1 [get_ports {monA_tx_data[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports monB_rst_n]
set_property PACKAGE_PIN J3 [get_ports monB_rst_n]
set_property IOSTANDARD LVCMOS33 [get_ports monB_rx_clk]
set_property PACKAGE_PIN H4 [get_ports monB_rx_clk]
set_property IOSTANDARD LVCMOS33 [get_ports monB_rx_en]
set_property PACKAGE_PIN M1 [get_ports monB_rx_en]
set_property IOSTANDARD LVCMOS33 [get_ports monB_tx_clk]
set_property PACKAGE_PIN P4 [get_ports monB_tx_clk]
set_property IOSTANDARD LVCMOS33 [get_ports monB_tx_en]
set_property PACKAGE_PIN N4 [get_ports monB_tx_en]
set_property IOSTANDARD LVCMOS33 [get_ports monA_rst_n]
set_property PACKAGE_PIN C3 [get_ports monA_rst_n]
set_property IOSTANDARD LVCMOS33 [get_ports monA_rx_en]
set_property IOSTANDARD LVCMOS33 [get_ports monA_rx_clk]
set_property PACKAGE_PIN G4 [get_ports monA_rx_clk]
set_property IOSTANDARD LVCMOS33 [get_ports monA_tx_en]
set_property IOSTANDARD LVCMOS33 [get_ports monA_tx_clk]
set_property PACKAGE_PIN B2 [get_ports monA_rx_en]
set_property PACKAGE_PIN F2 [get_ports monA_tx_clk]
set_property PACKAGE_PIN E2 [get_ports monA_tx_en]

create_clock -period 8.000 -name monB_rx_clk -waveform {0.000 4.000} [get_ports monB_rx_clk]
create_clock -period 8.000 -name monA_rx_clk [get_ports monA_rx_clk]
...
set_property PACKAGE_PIN L1 [get_ports {mdio[3]}]
set_property PACKAGE_PIN A3 [get_ports {mdio[2]}]
set_property PACKAGE_PIN L2 [get_ports {mdc[3]}]
set_property PACKAGE_PIN A2 [get_ports {mdc[2]}]

set_property PACKAGE_PIN L12 [get_ports trig_out]
set_property IOSTANDARD LVCMOS33 [get_ports trig_out]

set_property SLEW FAST [get_ports monA_tx_clk]
set_property DRIVE 8 [get_ports monA_tx_clk]
set_property DRIVE 8 [get_ports {mdc[3]}]
set_property DRIVE 8 [get_ports {mdc[2]}]
set_property DRIVE 8 [get_ports {mdc[1]}]
set_property DRIVE 8 [get_ports {mdc[0]}]
set_property DRIVE 12 [get_ports {mdio[3]}]
set_property DRIVE 12 [get_ports {mdio[2]}]
set_property DRIVE 12 [get_ports {mdio[1]}]
set_property DRIVE 12 [get_ports {mdio[0]}]
set_property SLEW SLOW [get_ports {mdc[3]}]
set_property SLEW SLOW [get_ports {mdc[2]}]
set_property SLEW SLOW [get_ports {mdc[1]}]
set_property SLEW SLOW [get_ports {mdc[0]}]
set_property DRIVE 8 [get_ports {monA_tx_data[3]}]
set_property DRIVE 8 [get_ports {monA_tx_data[2]}]
set_property DRIVE 8 [get_ports {monA_tx_data[1]}]
set_property DRIVE 8 [get_ports {monA_tx_data[0]}]
set_property SLEW FAST [get_ports {monA_tx_data[3]}]
set_property SLEW FAST [get_ports {monA_tx_data[2]}]
set_property SLEW FAST [get_ports {monA_tx_data[1]}]
set_property SLEW FAST [get_ports {monA_tx_data[0]}]
...
set_property DRIVE 8 [get_ports {monB_tx_data[3]}]
set_property DRIVE 8 [get_ports {monB_tx_data[2]}]
set_property DRIVE 8 [get_ports {monB_tx_data[1]}]
set_property DRIVE 8 [get_ports {monB_tx_data[0]}]
set_property SLEW FAST [get_ports {monB_tx_data[3]}]
set_property SLEW FAST [get_ports {monB_tx_data[2]}]
set_property SLEW FAST [get_ports {monB_tx_data[1]}]
set_property SLEW FAST [get_ports {monB_tx_data[0]}]
set_property DRIVE 8 [get_ports {portA_tx_data[3]}]
set_property DRIVE 8 [get_ports {portA_tx_data[2]}]
set_property DRIVE 8 [get_ports {portA_tx_data[1]}]
set_property DRIVE 8 [get_ports {portA_tx_data[0]}]
set_property SLEW FAST [get_ports {portA_tx_data[3]}]
set_property SLEW FAST [get_ports {portA_tx_data[2]}]
set_property SLEW FAST [get_ports {portA_tx_data[1]}]
set_property SLEW FAST [get_ports {portA_tx_data[0]}]
set_property DRIVE 8 [get_ports {portB_tx_data[3]}]
set_property DRIVE 8 [get_ports {portB_tx_data[2]}]
set_property DRIVE 8 [get_ports {portB_tx_data[1]}]
set_property DRIVE 8 [get_ports {portB_tx_data[0]}]
set_property SLEW FAST [get_ports {portB_tx_data[3]}]
set_property SLEW FAST [get_ports {portB_tx_data[2]}]
set_property SLEW FAST [get_ports {portB_tx_data[1]}]
set_property SLEW FAST [get_ports {portB_tx_data[0]}]
set_property DRIVE 8 [get_ports {qspi_dq[3]}]
set_property DRIVE 8 [get_ports {qspi_dq[2]}]
set_property DRIVE 8 [get_ports {qspi_dq[1]}]
set_property DRIVE 8 [get_ports {qspi_dq[0]}]
...
set_property DRIVE 8 [get_ports mcu_irq]
set_property SLEW SLOW [get_ports mcu_irq]
set_property DRIVE 8 [get_ports monA_rst_n]
set_property SLEW SLOW [get_ports monA_rst_n]
set_property DRIVE 8 [get_ports monA_tx_en]
set_property SLEW FAST [get_ports monA_tx_en]
set_property DRIVE 8 [get_ports monB_rst_n]
set_property SLEW SLOW [get_ports monB_rst_n]
set_property DRIVE 8 [get_ports monB_tx_clk]
set_property SLEW FAST [get_ports monB_tx_clk]
set_property DRIVE 8 [get_ports monB_tx_en]
set_property SLEW FAST [get_ports monB_tx_en]
set_property DRIVE 8 [get_ports portA_rst_n]
set_property SLEW SLOW [get_ports portA_rst_n]
set_property DRIVE 8 [get_ports portA_tx_clk]
set_property SLEW FAST [get_ports portA_tx_clk]
set_property DRIVE 8 [get_ports portA_tx_en]
set_property SLEW FAST [get_ports portA_tx_en]
set_property DRIVE 8 [get_ports portB_rst_n]
set_property SLEW SLOW [get_ports portB_rst_n]
set_property DRIVE 8 [get_ports portB_tx_clk]
set_property SLEW FAST [get_ports portB_tx_clk]
set_property DRIVE 8 [get_ports portB_tx_en]
set_property SLEW FAST [get_ports portB_tx_en]
set_property DRIVE 8 [get_ports trig_out]
set_property SLEW FAST [get_ports trig_out]

set_property BITSTREAM.CONFIG.CONFIGRATE 12 [current_design]
set_property BITSTREAM.CONFIG.SPI_BUSWIDTH 4 [current_design]
set_property CONFIG_MODE SPIx4 [current_design]

set_property PULLDOWN true [get_ports monA_rx_clk]
set_property PULLDOWN true [get_ports monB_rx_clk]
set_property PULLDOWN true [get_ports portA_rx_clk]
set_property PULLDOWN true [get_ports portB_rx_clk]
