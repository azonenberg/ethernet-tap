...
set_property DRIVE 4 [get_ports {mdc[3]}]
set_property DRIVE 4 [get_ports {mdc[2]}]
set_property DRIVE 4 [get_ports {mdc[1]}]
set_property DRIVE 4 [get_ports {mdc[0]}]
...
set_property DRIVE 4 [get_ports monA_rst_n]
...
set_property DRIVE 4 [get_ports monB_rst_n]
...
set_property DRIVE 4 [get_ports portA_rst_n]
...
set_property DRIVE 4 [get_ports portB_rst_n]
